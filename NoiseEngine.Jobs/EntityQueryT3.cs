...
namespace NoiseEngine.Jobs {
    public class EntityQuery<T1, T2, T3> :
        EntityQueryBase, IEnumerable<(Entity entity, T1 component1, T2 component2, T3 component3)>
        ...
        where T3 : struct, IEntityComponent
    {
        ...
        internal readonly ConcurrentDictionary<Entity, T3> components3;
            ...
            base(world, writableComponents, filter)
        {
            ...
            components3 = world.ComponentsStorage.AddStorage<T3>();
        }
        ...
        public IEnumerator<(Entity entity, T1 component1, T2 component2, T3 component3)> GetEnumerator() {
            foreach (Entity entity in Entities) {
                yield return (entity, components1[entity], components2[entity], components3[entity]);
            }
        }
        ...
        internal void SetComponent(Entity entity, T3 component) {
            ComponentsStorage<Entity>.SetComponent(components3, entity, component);
        }

        internal override void RegisterGroup(EntityGroup group) {
            if (group.HasComponent(typeof(T1)) && group.HasComponent(typeof(T2)) && group.HasComponent(typeof(T3)))
