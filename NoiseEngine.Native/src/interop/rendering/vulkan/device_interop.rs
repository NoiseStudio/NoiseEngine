...
use crate::{
    ...
    interop::{prelude::{InteropResult, InteropString}, interop_read_only_span::InteropReadOnlySpan},
...
extern "C" fn rendering_vulkan_device_interop_initialize(
    device: &Arc<VulkanDevice>, enabled_extensions: InteropReadOnlySpan<InteropString>
) -> InteropResult<()> {
