...
public class FileLogSink : TextWriterLogSink {
    ...
    /// <param name="settings">Sink settings, of which validity is asserted.</param>
    /// <returns>Sink writing to a file.</returns>
    public static FileLogSink CreateFromDirectory(string directory, TextWriterLogSinkSettings settings) {
