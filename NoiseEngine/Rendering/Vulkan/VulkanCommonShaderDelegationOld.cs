...
internal class VulkanCommonShaderDelegationOld : CommonShaderDelegationOld {
    ...
    public VulkanCommonShaderDelegationOld(ICommonShader shader, ShaderSettings settings) : base(shader) {
    ...
    private VulkanCommonShaderDelegationOld(ICommonShader newShader, VulkanCommonShaderDelegationOld old) : base(newShader) {
        module = old.module;
        layout = old.layout;
    ...
    internal override VulkanCommonShaderDelegationOld Clone(ICommonShader newShader) {
        return new VulkanCommonShaderDelegationOld(newShader, this);
    }
